...
class TaskController {
    ...
    getTasks = asyncHandler(async (req: Request, res: Response) => {
        const result = await this.taskService.getTasks(req.query as TaskFilters, getUserId(req), req.params.id as string);
        return res.json({
            success: true,
            data: result
        });
    ...
    updateTask = asyncHandler(async (req: Request, res: Response) => {
        const data: TaskInput = req.body;
        const result = await this.taskService.updateTask(data, getUserId(req), req.params.id as string);
        return res.json({
            success: true,
            data: result
        });
    ...
    deleteTask = asyncHandler(async (req: Request, res: Response) => {
        const result = await this.taskService.deleteTask(getUserId(req), req.params.id as string);
        return res.json({
            success: true,
            data: result,
